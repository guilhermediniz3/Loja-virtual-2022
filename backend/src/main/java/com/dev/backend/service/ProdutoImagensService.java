...
public class ProdutoImagensService {
	...
	public List<ProdutoImagens> buscarTodos(){
	 ...
	 public List<ProdutoImagens> buscarPorProduto(Long idProduto) {
	        ...
	        for (ProdutoImagens produtoImagens : listaProdutoImagens) {
	            try (InputStream in = new FileInputStream("C:/Users/guilherme-diniz/Desktop/lojas/Loja-virtual-2022/imagens/"+produtoImagens.getNome())) {
	...
	try {
		if(!file.isEmpty()) {
			...
			Path caminho = Paths
					.get("C:/Users/guilherme-diniz/Desktop/lojas/Loja-virtual-2022/imagens/" + nomeImagem );
